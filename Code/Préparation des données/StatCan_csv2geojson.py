...
var1 = 751 # Revenu total moyen des ménages en 2015 ($)
var2 = 1680 # % de ménages locataires consacrant 30 % ou plus de leur revenu aux frais de logement
...
for i in t:
    ...
    if i[0] != 'num' and i[var] != 'x' and i[var] != '..' and i[var] != 'F' and i[var] != '0':
        ...
        geoJson += '{ "type": "Feature","geometry": {"type": "Point", "coordinates": [' + str(lon1) + ',' + str(lat1) + ']},"properties": {"Rev":' + str(rev) + ',"Eff":' + str(eff) + '}},'
